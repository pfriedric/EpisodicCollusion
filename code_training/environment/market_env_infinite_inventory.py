...
# region ENVIRONMENT
class MarketEnvInfiniteInventoryEpisodic(environment.Environment):
    """This is meant to be used in the episodic setting but without inventory constraints.
    Unlike a regular MarketEnv, this one will never decrement the inventory. Literally only change.
    """
    ...
    def name(self) -> str:
        """Environment name."""
        return "MarketEnv-InfiniteInventoryEpisodic"
